...
INSERT INTO visits (animal_id, vet_id, visite_date)
VALUES 
    (
...
INSERT INTO visits (animal_id, vet_id, visite_date) SELECT * FROM (SELECT id FROM animals) animals_id, (SELECT id FROM vets) vets_ids, generate_series('1980-01-01'::timestamp, '2021-01-01', '4 hours') visit_timestamp;
